...
def ICEBEEM_wrapper(X, Y, S, ebm_hidden_size, n_layers_ebm, n_layers_flow, lr_flow, lr_ebm, seed,
    ...
    fce_ = ConditionalFCE(data=X.astype(np.float32), sources=S.astype(np.float32), segments=Y.astype(np.float32),
